...
func BenchmarkEncodeString(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		if err := Encode("Sparrow Framework", buf, Options{}); err != nil {
			b.Fatal(err)
		}
	}
}
func BenchmarkEncodeStringGob(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		buf.Reset()
		if err := enc.Encode("Sparrow Framework"); err != nil {
			b.Fatal(err)
		}
	}
}
...
func BenchmarkEncodeAtom(b *testing.B) {
	...
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
		if err := Encode(gen.Atom("Sparrow Framework"), buf, Options{}); err != nil {
			b.Fatal(err)
		}
	}
}
...
func BenchmarkEncodeAtomGob(b *testing.B) {
	...
	for i := 0; i < b.N; i++ {
		buf.Reset()
		if err := enc.Encode(gen.Atom("Sparrow Framework")); err != nil {
			b.Fatal(err)
		}
	}
}
...
func BenchmarkEncodeStructSDF(b *testing.B) {
...
func BenchmarkEncodeSliceStructSDF(b *testing.B) {
	var regCache *sync.Map
...
func BenchmarkDecodeStructSDF(b *testing.B) {
	var regCache *sync.Map
...
func BenchmarkDecodeSliceStructSDF(b *testing.B) {
	var regCache *sync.Map
